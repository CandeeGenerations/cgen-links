...
export abstract class IQuery {
  abstract findLinksByOwner(
    owner: string,
    _size?: number,
    _cursor?: string,
  ): QueryFindLinksByOwnerPage | Promise<QueryFindLinksByOwnerPage>

  abstract findAuthorizedUser(
    googleId: string,
    authorized: boolean,
  ): User | Promise<User>
  ...
  abstract findLinksByTitle(
    owner: string,
    title: string,
    _size?: number,
    _cursor?: string,
  ): QueryFindLinksByTitlePage | Promise<QueryFindLinksByTitlePage>
  ...
  abstract findClicksByOwner(
    owner: string,
    _size?: number,
    _cursor?: string,
  ): QueryFindClicksByOwnerPage | Promise<QueryFindClicksByOwnerPage>

  abstract findSettingsByID(id: string): Settings | Promise<Settings>

  abstract findLinksByDestination(
    owner: string,
    destination: string,
    _size?: number,
    _cursor?: string,
  ): QueryFindLinksByDestinationPage | Promise<QueryFindLinksByDestinationPage>
}
